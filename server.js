...
// Cấu hình: hpkey/config.js + hpkey/public-key.js. Giữ nguyên interface
// validateLicenseKey() nên gate + role CREATOR không phải sửa gì.
// (gift-sheet & auto-update vẫn dùng LICENSE_WORKER_URL cũ — migrate sau)
